	...
	private void initialize() throws IOException {
		...
		btnIniciar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0){
				...
				MostrarNaves tipoDeNaveParaMostrar = new MostrarNaves();
				for(Nave unaNave: listaNaves){
					try {
						tipoDeNaveParaMostrar.mostrarNaves(mat,unaNave);
					} catch (IOException e) {
						e.printStackTrace();
					}
		...
		btnPasarTurno.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0){
				...
				MostrarDisparos tipoDeDisparosParaMostrar = new MostrarDisparos();
				for(Disparo disparo: disparos){
					try {
						 tipoDeDisparosParaMostrar.mostrarDisparos(mat,disparo);
					} catch (IOException e) {
						e.printStackTrace();
					}
				}
