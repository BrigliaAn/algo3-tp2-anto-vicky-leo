...
public class VistaLanchaVertical extends VistaNave{

	private String rutaImagenParte1 = "/Imagenes/Naves/lanchaParte1Vertical.png";
	private String rutaImagenParte2 = "/Imagenes/Naves/lanchaParte2Vertical.png";
	private ImageIcon imagenParte1;
	private ImageIcon imagenParte2;

	
	public VistaLanchaVertical(Nave lancha) throws IOException{
		super(lancha);
